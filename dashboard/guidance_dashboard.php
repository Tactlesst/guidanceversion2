...
$stats = [
    ...
    'my_counseling' => $db->prepare("SELECT COUNT(*) FROM counseling_appointments WHERE assigned_advocate_id=? AND status='confirmed'")->execute([$uid]) ? $db->query("SELECT FOUND_ROWS()")->fetchColumn() : 0,
...
<head>
    ...
    <title>Guidance Dashboard - SRCB Guidance</title>
...
<aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-[#163269] to-[#0f1f42] text-white z-50 transition-transform duration-300 -translate-x-full lg:translate-x-0 shadow-2xl">
    ...
    <nav class="mt-4 px-3 space-y-1">
        <a href="guidance_dashboard.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-white/15 text-white transition-colors text-sm">
    ...
    <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-white/10">
        <div class="flex items-center gap-3">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="text-[10px] text-white/50 uppercase">Guidance Advocate</div>
            </div>
...
<header class="fixed top-0 left-0 lg:left-64 right-0 h-14 bg-white border-b border-gray-200 z-40 flex items-center justify-between px-5">
    ...
    <h1 class="text-lg font-bold text-primary hidden lg:block">Guidance Advocate Dashboard</h1>
    <div class="flex items-center gap-3">
        <div class="relative">
...
<div class="lg:ml-64 pt-14">
    <div class="p-5">
        <h1 class="text-xl font-bold text-primary mb-5"><i class="fas fa-home mr-2"></i>Guidance Advocate Dashboard</h1>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-xs text-gray-400">My Counseling</p>
                        <p class="text-lg font-bold text-gray-800"><?= $stats['my_counseling'] ?></p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl p-4 shadow-sm">
